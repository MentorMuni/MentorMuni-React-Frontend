    ...
    <div className="bg-white rounded-2xl border border-[#E0DCCF] p-8 shadow-sm">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Complete analysis of your transition potential</p>
        </div>
        {can_transition ? (
      ...
      <div className="grid md:grid-cols-4 gap-6">
        ...
        <div className={`bg-gradient-to-br ${getReadinessBgColor()} border rounded-xl p-6`}>
          <p className="text-muted-foreground text-sm font-semibold mb-2">Readiness Score</p>
          <div className="flex items-baseline gap-1 mb-4">
            <span className={`text-4xl font-bold ${getReadinessColor()}`}>
              {readiness_score.toFixed(0)}%
            </span>
          </div>
          <div className="w-full bg-[#E0DCCF] rounded-full h-2">
            <div
        ...
        <div className="bg-gradient-to-br from-cyan-600/20 to-cyan-400/10 border border-cyan-600/50 rounded-xl p-6">
          <p className="text-muted-foreground text-sm font-semibold mb-2">Confidence</p>
          <div className="flex items-baseline gap-1 mb-4">
          ...
          <p className="text-muted-foreground text-xs mt-2">How sure we are</p>
        </div>

        {/* Estimated Time */}
        <div className="bg-gradient-to-br from-purple-600/20 to-purple-400/10 border border-purple-600/50 rounded-xl p-6">
          <p className="text-muted-foreground text-sm font-semibold mb-2">Estimated Time</p>
          <div className="flex items-baseline gap-1 mb-4">
            <span className="text-4xl font-bold text-purple-400">
              {estimated_weeks}
            </span>
            <span className="text-muted-foreground text-lg">weeks</span>
          </div>
        ...
        <div className={`bg-gradient-to-br ${
          ...
          <p className="text-muted-foreground text-sm font-semibold mb-2">Can Transition?</p>
          <div className="mb-4">
