        ...
        <main className="flex-1 min-w-0">
          ...
          <div className="mb-16">
            ...
            <div className="flex gap-4 flex-wrap mb-8">
              <div className="px-4 py-2 bg-[#4F46E5]/20 border border-[#4F46E5]/50 rounded-lg text-sm">⏱️ 6-8 hours comprehensive</div>
          ...
          <section id="intro" className="mb-16">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
              ...
              <div className="space-y-4">
                <div className="bg-[#1e1e1e] p-4 rounded-lg border border-green-400/30">
                  ...
                  <p className="text-[#94A3B8] text-sm mt-2">Growing field with increasing demand. IBM, Google, Microsoft investing billions. Early adopters have significant career advantage.</p>
                </div>
                <div className="bg-[#1e1e1e] p-4 rounded-lg border border-blue-400/30">
                  ...
                  <p className="text-[#94A3B8] text-sm mt-2">Quantum computers can solve certain problems (optimization, factorization, simulation) exponentially faster than classical computers.</p>
                </div>
                <div className="bg-[#1e1e1e] p-4 rounded-lg border border-purple-400/30">
                  ...
                  <p className="text-[#94A3B8] text-sm mt-2">Revolutionize drug discovery, materials science, artificial intelligence, and cryptography.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8">
              ...
              <div className="bg-[#1e1e1e] p-4 rounded-lg border border-white/10">
                <p className="text-[#94A3B8] text-sm mb-3"><strong>Part 1: Theory (Sections 1-6)</strong> - Quantum mechanics foundations, qubits, gates, circuits</p>
                <p className="text-[#94A3B8] text-sm mb-3"><strong>Part 2: Algorithms (Sections 7-8)</strong> - Major quantum algorithms with detailed explanations</p>
                <p className="text-[#94A3B8] text-sm mb-3"><strong>Part 3: Practice (Sections 9-15)</strong> - Hardware, Python programming, applications, interview prep, projects</p>
                <p className="text-[#94A3B8] text-sm"><strong>Part 4: Resources (Section 16)</strong> - FAQ, career guidance, further learning</p>
              </div>
            </div>
          </section>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
              ...
              <div className="space-y-4">
                <div className="bg-[#1e1e1e] p-4 rounded-lg border border-white/10">
                  ...
                  <p className="text-[#94A3B8] text-sm mt-2">Quantum states are represented as vectors in complex Hilbert space. |0⟩ = [1, 0]ᵀ and |1⟩ = [0, 1]ᵀ are basis states.</p>
                </div>
                <div className="bg-[#1e1e1e] p-4 rounded-lg border border-white/10">
                  <strong className="text-cyan-400">Complex Numbers</strong>
                  <p className="text-[#94A3B8] text-sm mt-2">Quantum amplitudes are complex numbers α = a + bi. Probability = |α|² = a² + b². Phase (angle) matters for interference.</p>
                </div>
                <div className="bg-[#1e1e1e] p-4 rounded-lg border border-white/10">
                  <strong className="text-cyan-400">Tensor Products</strong>
                  <p className="text-[#94A3B8] text-sm mt-2">Multi-qubit states combine via tensor product (⊗). Two qubits: |ψ₁⟩ ⊗ |ψ₂⟩</p>
                </div>
              </div>
            </div>
          ...
          <section id="classical-vs-quantum" className="mb-16">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8">
              ...
              <p className="text-[#94A3B8] mb-4">The key advantage: superposition gives exponential scaling.</p>
              <div className="bg-[#1e1e1e] p-4 rounded-lg border border-white/10">
                <p className="text-[#94A3B8] text-sm"><strong>Classical:</strong> 3 bits = 8 possible values (one at a time)</p>
                <p className="text-[#94A3B8] text-sm"><strong>Quantum:</strong> 3 qubits = can represent all 8 states simultaneously</p>
                <p className="text-[#94A3B8] text-sm mt-3"><strong>Scaling:</strong> n qubits represent 2ⁿ states simultaneously</p>
                <p className="text-[#94A3B8] text-sm">→ 300 qubits: 2³⁰⁰ (more than atoms in universe) classical states at once!</p>
              </div>
            </div>
          </section>
          ...
          <section id="qubits" className="mb-16">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
              ...
              <div className="bg-[#1e1e1e] p-4 rounded-lg border border-white/10 mb-4">
                <p className="text-[#94A3B8] text-sm mb-3"><strong>General single-qubit state:</strong></p>
                <p className="text-[#94A3B8] text-sm font-mono">|ψ⟩ = α|0⟩ + β|1⟩</p>
                <p className="text-[#94A3B8] text-sm mt-3">Where α and β are complex numbers with constraint: |α|² + |β|² = 1</p>
                <p className="text-[#94A3B8] text-sm mt-3"><strong>What it means:</strong> Qubit is literally both 0 and 1 until measured, with probabilities |α|² for 0 and |β|² for 1.</p>
              </div>
              <p className="text-[#94A3B8] mb-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
              ...
              <div className="bg-[#1e1e1e] p-4 rounded-lg border border-white/10">
                <p className="text-[#94A3B8] text-sm mb-2"><strong>Bloch Sphere Representation:</strong></p>
                <p className="text-[#94A3B8] text-sm font-mono">|ψ⟩ = cos(θ/2)|0⟩ + e^(iφ)sin(θ/2)|1⟩</p>
                <p className="text-[#94A3B8] text-sm mt-2">θ (theta): polar angle, φ (phi): azimuthal angle</p>
              </div>
            </div>
          ...
          <section id="multiqubit" className="mb-16">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
              ...
              <div className="bg-[#1e1e1e] p-4 rounded-lg border border-white/10 mb-4">
                <p className="text-[#94A3B8] text-sm font-mono">|ψ₁⟩ ⊗ |ψ₂⟩ = αγ|00⟩ + αδ|01⟩ + βγ|10⟩ + βδ|11⟩</p>
                <p className="text-[#94A3B8] text-sm mt-3">4 basis states, coefficients factorizable = unentangled (separable)</p>
              </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8">
              ...
              <div className="space-y-3">
                <div className="bg-[#1e1e1e] p-3 rounded border border-white/10">
                  <p className="text-[#94A3B8] text-sm font-mono">|Φ+⟩ = (1/√2)(|00⟩ + |11⟩)</p>
                  <p className="text-[#94A3B8] text-sm mt-1">Perfect correlation: same outcome always</p>
                </div>
                <div className="bg-[#1e1e1e] p-3 rounded border border-white/10">
                  <p className="text-[#94A3B8] text-sm font-mono">|Φ-⟩ = (1/√2)(|00⟩ - |11⟩)</p>
                  <p className="text-[#94A3B8] text-sm mt-1">Perfect anti-correlation with phase</p>
                </div>
                <div className="bg-[#1e1e1e] p-3 rounded border border-white/10">
                  <p className="text-[#94A3B8] text-sm font-mono">|Ψ±⟩ = (1/√2)(|01⟩ ± |10⟩)</p>
                  <p className="text-[#94A3B8] text-sm mt-1">Anti-correlation in different basis</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="gates" className="mb-16">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
              ...
              <div className="space-y-4">
                <div className="bg-[#1e1e1e] p-4 rounded border border-white/10">
                  <p className="text-cyan-400 font-bold text-sm">Pauli Gates (X, Y, Z)</p>
                  <p className="text-[#94A3B8] text-sm mt-2">X (NOT gate): Flips |0⟩ ↔ |1⟩. Y, Z rotations around y, z axes by π</p>
                </div>
                <div className="bg-[#1e1e1e] p-4 rounded border border-white/10">
                  <p className="text-cyan-400 font-bold text-sm">Hadamard (H)</p>
                  <p className="text-[#94A3B8] text-sm mt-2">Creates superposition. H|0⟩ = |+⟩ = (1/√2)(|0⟩+|1⟩). H² = I (involutory)</p>
                </div>
                <div className="bg-[#1e1e1e] p-4 rounded border border-white/10">
                  <p className="text-cyan-400 font-bold text-sm">Phase Gates (S, T, Rz)</p>
                  <p className="text-[#94A3B8] text-sm mt-2">Modify phase. S adds π/2, T adds π/4. Don't flip basis state, change relative phase</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8">
              ...
              <div className="space-y-4">
                <div className="bg-[#1e1e1e] p-4 rounded border border-white/10">
                  ...
                  <p className="text-[#94A3B8] text-sm mt-2">If control qubit is |1⟩, apply X to target. Creates entanglement. Essential for quantum algorithms</p>
                </div>
                <div className="bg-[#1e1e1e] p-4 rounded border border-white/10">
                  <p className="text-cyan-400 font-bold text-sm">Toffoli (CCX)</p>
                  <p className="text-[#94A3B8] text-sm mt-2">Controlled-controlled-X. If both controls are |1⟩, flip target. Universal for classical logic</p>
                </div>
                <div className="bg-[#1e1e1e] p-4 rounded border border-white/10">
                  <p className="text-cyan-400 font-bold text-sm">Swap Gate</p>
                  <p className="text-[#94A3B8] text-sm mt-2">Exchanges two qubits' states. Swap = 3 CNOTs</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="circuits" className="mb-16">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
              ...
              <div className="bg-[#1e1e1e] p-4 rounded-lg border border-white/10 mb-4">
                <p className="text-[#94A3B8] text-sm font-mono">q₀ ──[H]──●──[M]──</p>
                <p className="text-[#94A3B8] text-sm font-mono">q₁ ────────⊕──[M]──</p>
                <p className="text-[#94A3B8] text-sm mt-3">Simple Bell state preparation: Hadamard on q₀, CNOT with q₀ control, measure both</p>
              </div>
              <p className="text-[#94A3B8]">
...
# Classical exhaustive search: O(N)`} language="python" />
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8">
              ...
              <div className="bg-[#1e1e1e] p-4 rounded-lg border border-white/10">
                <p className="text-[#94A3B8] text-sm mb-2"><strong>Key Insight:</strong> Uses Quantum Fourier Transform to find period of modular exponentiation function.</p>
                <p className="text-[#94A3B8] text-sm">Period finding generates superposition, QFT extracts period classically (interference amplifies success probability)</p>
              </div>
            </div>
          </section>
          ...
          <section id="error-correction" className="mb-16">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
              ...
              <div className="space-y-3">
                <div className="bg-[#1e1e1e] p-3 rounded border border-red-400/30">
                  <p className="text-[#94A3B8] text-sm"><strong>T1 Relaxation:</strong> Excited state decays to ground. Energy loss.</p>
                </div>
                <div className="bg-[#1e1e1e] p-3 rounded border border-red-400/30">
                  <p className="text-[#94A3B8] text-sm"><strong>T2 Dephasing:</strong> Relative phase information lost. Superposition destroyed.</p>
                </div>
                <div className="bg-[#1e1e1e] p-3 rounded border border-red-400/30">
                  <p className="text-[#94A3B8] text-sm"><strong>Gate Errors:</strong> Imperfect gate implementations. ~0.1-1% error per gate today.</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8">
              ...
              <div className="bg-[#1e1e1e] p-4 rounded-lg border border-white/10">
                <p className="text-[#94A3B8] text-sm"><strong>Surface Codes:</strong> 2D grid of qubits. Error threshold ~1%. Scalable with fabrication improvements.</p>
                <p className="text-[#94A3B8] text-sm mt-2"><strong>Resource Overhead:</strong> 1 logical qubit ≈ 1000-10000 physical qubits today. Major challenge.</p>
              </div>
            </div>
          </section>
          ...
          <section id="hardware" className="mb-16">
            ...
            <div className="space-y-4">
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                ...
                <p className="text-[#94A3B8] text-sm">IBM, Google, Rigetti. Transmons: artificial atoms at mK temperature. Easy control but cooling expensive. Fastest decoherence times (microseconds).</p>
              </div>

              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <h3 className="text-xl font-bold mb-3">Trapped Ions</h3>
                <p className="text-[#94A3B8] text-sm">IonQ, Honeywell. Individual atoms trapped by electric fields. Excellent coherence (seconds). Slower operations but higher fidelity.</p>
              </div>

              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <h3 className="text-xl font-bold mb-3">Photonic Systems</h3>
                <p className="text-[#94A3B8] text-sm">Xanadu, PsiQuantum. Photons as qubits. Room temperature operation. Challenging to create deterministic gates.</p>
              </div>

              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <h3 className="text-xl font-bold mb-3">Neutral Atoms</h3>
                <p className="text-[#94A3B8] text-sm">Atom Computing, Pasqal. Scalable, good coherence. Promising for near-term devices.</p>
              </div>
            </div>
          </section>
    ...
    job = session.run(circuit)`} language="python" />
          ...
          <section id="complexity" className="mb-16">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
              ...
              <div className="bg-[#1e1e1e] p-4 rounded-lg border border-white/10">
                <p className="text-[#94A3B8] text-sm mb-2"><strong>Known relationships:</strong></p>
                <p className="text-[#94A3B8] text-sm">P ⊆ BQP (classic is subset of quantum)</p>
                <p className="text-[#94A3B8] text-sm">BQP ⊆ PSPACE (quantum is subset of polynomial space)</p>
                <p className="text-[#94A3B8] text-sm">BQP might contain NP (not proven equal)</p>
                <p className="text-[#94A3B8] text-sm mt-2"><strong>Unsolved:</strong> P = BQP? BQP = NP?</p>
              </div>
            </div>
          ...
          <section id="applications" className="mb-16">
            ...
            <div className="space-y-4">
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                ...
                <p className="text-[#94A3B8] text-sm">Threat: Shor breaks RSA. Solution: Post-quantum cryptography (lattice-based, hash-based codes). Opportunity: Quantum Key Distribution (QKD) for theoretically secure communication.</p>
              </div>

              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <h3 className="text-xl font-bold mb-3">Optimization</h3>
                <p className="text-[#94A3B8] text-sm">QAOA, VQE solve combinatorial optimization faster. Applications: portfolio optimization, drug discovery, logistics, supply chain.</p>
              </div>

              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <h3 className="text-xl font-bold mb-3">AI & Machine Learning</h3>
                <p className="text-[#94A3B8] text-sm">Quantum ML might accelerate certain algorithms. Variational autoencoders, classification, feature mapping research.</p>
              </div>

              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <h3 className="text-xl font-bold mb-3">Chemistry & Materials</h3>
                <p className="text-[#94A3B8] text-sm">Simulate molecular systems (exponential classical complexity). Drug discovery, catalyst design, materials properties.</p>
              </div>

              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <h3 className="text-xl font-bold mb-3">Financial Modeling</h3>
                <p className="text-[#94A3B8] text-sm">Monte Carlo simulations, portfolio optimization, risk analysis with quantum acceleration.</p>
              </div>
            </div>
          </section>
          ...
          <section id="interview" className="mb-16">
            ...
            <div className="space-y-6">
              <div>
                ...
                <details className="group cursor-pointer bg-white/5 border border-white/10 hover:border-indigo-400/30 rounded-xl p-6 mb-4">
                  <summary className="font-bold text-indigo-400 cursor-pointer">1. What's the difference between a qubit and a bit?</summary>
                  <p className="text-[#94A3B8] text-sm mt-3">A bit is 0 or 1. A qubit can be 0, 1, or superposition (both simultaneously) described by |ψ⟩ = α|0⟩ + β|1⟩. Measurement collapses to 0 or 1 with probabilities |α|² and |β|².</p>
                </details>
              </div>

              <div>
                <h3 className="font-bold text-cyan-400 mb-3 text-lg">Intermediate Level</h3>
                <details className="group cursor-pointer bg-white/5 border border-white/10 hover:border-cyan-400/30 rounded-xl p-6 mb-4">
                  <summary className="font-bold text-cyan-400 cursor-pointer">2. Explain entanglement and why it's important.</summary>
                  <p className="text-[#94A3B8] text-sm mt-3">Entanglement: qubits are quantum-mechanically linked such that measuring one instantly determines the other. Bell state: (1/√2)(|00⟩ + |11⟩). Importance: enables nonlocal correlations, exponential state space for distributed information, crucial for quantum algorithms (CNOT creates entanglement).</p>
                </details>
              </div>

              <div>
                <h3 className="font-bold text-green-400 mb-3 text-lg">Advanced Level</h3>
                <details className="group cursor-pointer bg-white/5 border border-white/10 hover:border-green-400/30 rounded-xl p-6">
                  ...
                  <p className="text-[#94A3B8] text-sm mt-3">Approach: (1) Understand classical complexity. (2) Identify quantum advantage (superposition, entanglement, interference). (3) Select appropriate gate set (Hadamard for superposition, CNOT for entanglement, phase gates for interference). (4) Design oracle if needed. (5) Analyze circuit depth, qubit count, error tolerance. Example Grover: Hadamard (superposition), oracle (mark), diffusion (amplify).</p>
                </details>
              </div>
            </div>
          </section>
          ...
          <section id="projects" className="mb-16">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
              ...
              <p className="text-[#94A3B8] mb-4">Build circuit that creates Bell states and verify entanglement.</p>
...
for state in ['phi_plus', 'phi_minus', 'psi_plus', 'psi_minus']:
    ...
    print(f"{state}: {result.get_counts()}")`} language="python" />
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8">
              ...
              <p className="text-[#94A3B8] mb-4">Implement Grover's algorithm for 3-qubit search marking |101⟩.</p>
              <div className="bg-[#1e1e1e] p-4 rounded-lg border border-white/10">
                <p className="text-[#94A3B8] text-sm mb-2"><strong>Challenge:</strong> Modify code to mark different states, count iterations needed, compare success rates.</p>
              </div>
            </div>
          </section>
            ...
            <div className="mt-16 bg-gradient-to-r from-indigo-600/20 to-purple-600/20 border border-indigo-400/30 rounded-xl p-8">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                >
                  ...
                  <p className="text-[#94A3B8] text-sm">Understand LLMs before exploring quantum AI applications.</p>
                </a>
                ...
                >
                  ...
                  <p className="text-[#94A3B8] text-sm">Learn retrieval systems for advanced AI.</p>
                </a>
                ...
                >
                  ...
                  <p className="text-[#94A3B8] text-sm">Test your quantum & AI knowledge.</p>
                </a>
              </div>
            </div>
          </section>
