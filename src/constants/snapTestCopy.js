/** Copy for the 5-second snap readiness test funnel */
...
export const SNAP_RESULT_EYEBROW = 'Snapshot unlocked';
export const SNAP_RESULT_HEADLINE = "You're closer than you think.";
export const SNAP_RESULT_SUB =
  'This is just your snapshot — your stage and top gaps. Take the full 5-min check to get your real score and an exact plan to fix what\'s holding you back.';
...
export const SNAP_RESULT_GAP_HEADLINE = 'Gaps to fix next';
...
export const SNAP_RESULT_CTA_PRIMARY = 'Unlock my real readiness score — free';
export const SNAP_RESULT_CTA_SUB = '~5 min · AI + human mentor loop · Know before the panel does';
export const SNAP_RESULT_MENTOR_LINE =
