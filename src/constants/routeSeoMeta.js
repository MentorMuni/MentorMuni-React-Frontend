...
export const ROUTE_SEO = {
  ...
  '/snap-test': {
    ...
    description:
      'Seven taps in under 7 seconds — see where you stand vs 100 students, your selection chance, and gaps before campus drives. Then take the free full readiness check.',
    keywords:
