...
function emptyDrop(today, yesterday) {
  return {
    ...
    greeting: 'Nothing from yesterday — so there’s no plan to show yet.',
    what_changed: '',
    diagnosis: '',
    actions: [
      {
        order: 1,
        title: 'Add one clear note tonight',
        do_exactly:
          'Write one note: what’s stuck + what “done” looks like. Example: “Arrays freeze me — I want 2 easy problems submitted without watching a video.”',
        why_this_works: 'Tomorrow’s plan can only be specific if tonight’s note is specific.',
        done_when: 'One open note is on the wall with a clear finish line.',
        timebox_minutes: 5,
        note_ids: [],
      },
    ],
    callout: 'Add one note before you sleep. Tomorrow you’ll get a short plan.',
    closing: '',
    source: 'empty',
    model: null,
  };
